...
{
    public class ResetPassword_VerifyOTPHandler : IRequestHandler<ResetPassword_VerifyOTPCommand, ApiResponse<object>>
    {
        private readonly IUserRepository _userRepository;
        private readonly IOTPManagerRepository _oTPManagerRepository;

        public ResetPassword_VerifyOTPHandler(IUserRepository userRepository,
        ...
        public async Task<ApiResponse<object>> Handle(ResetPassword_VerifyOTPCommand request, CancellationToken cancellationToken)
        {
            try
            {
