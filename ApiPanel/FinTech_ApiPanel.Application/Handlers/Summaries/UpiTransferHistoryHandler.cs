...
{
    public class UpiTransferHistoryHandler : IRequestHandler<UpiTransferHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public UpiTransferHistoryHandler(IMapper mapper,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(UpiTransferHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    var payoutHistoryDto = TransactionLogFactory.GetTransactionLogDto(tx, userList.ToList());
