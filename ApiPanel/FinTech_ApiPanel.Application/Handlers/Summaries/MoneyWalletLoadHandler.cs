...
{
    public class MoneyWalletLoadHandler : IRequestHandler<MoneyWalletLoadHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public MoneyWalletLoadHandler(ITransactionLogRepository transactionLogRepository,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(MoneyWalletLoadHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
        ...
        byte[] GetIncludedLogTypes()
        {
            return new[]
            {
                ...
                (byte)LogType.AcceptFundRequest,
            };
        }
    }
}
