...
{
    internal class UTIPANHistoryHandler : IRequestHandler<UTIPANHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public UTIPANHistoryHandler(ITransactionLogRepository transactionLogRepository,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(UTIPANHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    var payoutHistoryDto = TransactionLogFactory.GetTransactionLogDto(log, userList.ToList());
                    return payoutHistoryDto;
                });
