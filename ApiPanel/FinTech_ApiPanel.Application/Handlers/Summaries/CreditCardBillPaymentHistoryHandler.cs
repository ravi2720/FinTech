...
{
    internal class CreditCardBillPaymentHistoryHandler : IRequestHandler<CreditCardBillPaymentHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public CreditCardBillPaymentHistoryHandler(ITransactionLogRepository transactionLogRepository,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(CreditCardBillPaymentHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                logs = logs.Where(x => x.LogType == (byte)LogType.BillPayment).ToList();
