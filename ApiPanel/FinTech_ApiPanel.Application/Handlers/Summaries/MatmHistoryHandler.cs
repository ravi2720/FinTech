...
{
    public class MatmHistoryHandler : IRequestHandler<MatmHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public MatmHistoryHandler(IMapper mapper,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(MatmHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
