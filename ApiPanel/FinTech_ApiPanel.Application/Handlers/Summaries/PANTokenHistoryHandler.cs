...
{
    public class PANTokenHistoryHandler : IRequestHandler<PANTokenHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public PANTokenHistoryHandler(ITransactionLogRepository transactionLogRepository,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(PANTokenHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
