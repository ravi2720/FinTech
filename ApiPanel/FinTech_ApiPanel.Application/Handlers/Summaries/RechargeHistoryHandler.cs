...
{
    public class RechargeHistoryHandler : IRequestHandler<RechargeHistoryQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public RechargeHistoryHandler(IMapper mapper,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(RechargeHistoryQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                walletTransactions = walletTransactions
                    .Where(x => x.LogType == (byte)LogType.Recharge_Goter)
                    .ToList();
