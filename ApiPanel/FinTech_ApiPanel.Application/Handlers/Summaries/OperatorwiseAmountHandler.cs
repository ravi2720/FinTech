...
{
    internal class OperatorwiseAmountHandler : IRequestHandler<OperatorwiseAmountQuery, ApiResponse<PagedResponse<TransactionLogDto>>>
    {
        ...
        public OperatorwiseAmountHandler(ITransactionLogRepository transactionLogRepository,
        ...
        public async Task<ApiResponse<PagedResponse<TransactionLogDto>>> Handle(OperatorwiseAmountQuery request, CancellationToken cancellationToken)
        {
            try
            {
