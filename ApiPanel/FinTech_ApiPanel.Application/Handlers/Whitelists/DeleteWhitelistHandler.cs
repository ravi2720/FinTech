...
{
    public class DeleteWhitelistHandler : IRequestHandler<DeleteWhitelistCommand, ApiResponse>
    {
        private readonly IWhitelistRepository _whitelistRepository;
        private readonly IMapper _mapper;
        private readonly ITokenService _tokenService;
        public DeleteWhitelistHandler(IWhitelistRepository whitelistRepository,
        ...
        public async Task<ApiResponse> Handle(DeleteWhitelistCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _whitelistRepository.DeleteAsync(request.Id);
