...
public partial class Admin_HistoryServiceActiveFromAdmin : System.Web.UI.Page
{
    ...
    private void fillTransactionDetails()
    {
        ...
        dt = cls.select_data_dt("PROC_ServiceActiveByAdmin_Report '',0,'" + txtfromdate.Text + "','" + txttodate.Text + "'");
