...
public partial class Admin_AadharHistory : System.Web.UI.Page
{
    ...
    private void fillTransactionDetails()
    {
        ...
        dt = cls.select_data_dt("PROC_AadharPayTransaction '" + txtSearch.Text + "',0,'" + txtfromdate.Text + "','" + txttodate.Text + "','" + dllStatus.SelectedValue + "'");
