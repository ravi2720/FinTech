...
public partial class Admin_CashDepositTransaction : System.Web.UI.Page
{
    ...
    private void fillTransactionDetails()
    {
        ...
        dt = cls.select_data_dt("PROC_CashDepositTransaction '" + txtSearch.Text + "',0,'" + txtfromdate.Text + "','" + txttodate.Text + "','" + dllStatus.SelectedValue + "'");
