<%@ Page Title="" Language="C#" MasterPageFile="~/DashBoard.master" AutoEventWireup="true" CodeFile="wish-list.aspx.cs" Inherits="Member_wish_list" %>
							...
							<div class="row">
									...
									<div class="card item-card ">
										...
										<div class="card-footer text-center">
											<div class="text-center px-2">
												<a href="product-cart.aspx" class="btn btn-md btn-primary mb-2 ms-2 w-45"><i class="fe fe-shopping-cart me-2"></i>Add to Cart</a>
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/02.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/03.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/04.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/05.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
											<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/06.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/09.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/08.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/07.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
								...
								<div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 alert wishlist-card">
									<div class="card item-card">
										<div class="card-body pb-0">
											<div class="text-center zoom">
												<a href="products.html"><img class="w-100 rounded-5" src="../assets/img/ecommerce/11.jpg"  alt="img" ></a>
											</div>
											<div class="card-body px-0 pb-3">
												<div class="row">
													<div class="col-9">
