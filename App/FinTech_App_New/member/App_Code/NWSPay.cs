...
public class NWSPay
{
    ...
    public readonly static string Client_Id = "BH9eAiK7yLa9H9W2";
    public readonly static string Client_Secret = "Pd6MyHbNYKgxKi7FmhAMTcvkxTWlf0gg";
    public readonly static string EncryptionKey = "cCrxj8EtKQDYsUC3IQ376gqSrbSYQiDY";
    ...
    public static string GetMobileInfo(string OutLet, string mobile)
    {
        ...
        var client = new RestClient($"{baseUrl}/Recharge/mobile-info?mobile={Uri.EscapeDataString(mobile)}");
        client.Timeout = -1;
        var request = new RestRequest(Method.GET);
        request.AddHeader("Content-Type", "application/json");
        request.AddHeader("Auth-Code", NWSPay.Auth_Code);
