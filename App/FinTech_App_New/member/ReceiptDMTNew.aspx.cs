...
public partial class Member_ReceiptDMTNew : System.Web.UI.Page
{
    ...
    public void CheckData()
    {
        ...
        if (dtWalletTransaction.Rows.Count > 0)
        {
            ...
            lblStatus.Text = (dtWalletTransaction.Rows[0]["sTATUS"].ToString().ToUpper() == "PROCESSED" ? "Success" : dtWalletTransaction.Rows[0]["sTATUS"].ToString());
            lblStatus.ForeColor = (dtWalletTransaction.Rows[0]["sTATUS"].ToString().ToUpper() == "PROCESSED" ? System.Drawing.Color.Green : System.Drawing.Color.Red);
