...
public partial class Member_MATMCommission : System.Web.UI.Page
{
    ...
    private void BindDataAepsCommission()
    {
        try
        {
            dt = objconnection.select_data_dt("EXEC ManageMATMCommission 'GetByPackageID','" + 0 + "' ,'" + dtMember.Rows[0]["PackageID"] + "'");
