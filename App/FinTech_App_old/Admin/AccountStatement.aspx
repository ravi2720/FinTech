<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AccountStatement.aspx.cs" Inherits="Admin_AccountStatement" %>
                                                    ...
                                                    <asp:Repeater ID="gvTransactionHistory" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><%# Eval("AMOUNT") %></td>
                                                                <td>
                                                                    <span class='<%# (Eval("TYPE").ToString().ToUpper()=="DR"?"btn btn-danger":"btn btn-success") %>'><%# Eval("TYPE") %></span></td>
