<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="PayoutSurcharge.aspx.cs" Inherits="Admin_PayoutSurcharge" %>
            ...
            <asp:UpdatePanel runat="server" ID="updateRolePanel">
                <ContentTemplate>
                    <div class="card card-primary">
                        <div class="card-header">Payout Surcharge Details</div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList runat="server" ID="dllPaymentType" CssClass="form-control"></asp:DropDownList> 
                                    </div>
                                    <div class="col-md-2">
