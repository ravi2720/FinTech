<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="CreateInvoice.aspx.cs" Inherits="Admin_CreateInvoice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="http://nidhi.idspay.in/app-assets/css/pages/app-todo.min.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" id="appinvoice">
                            ...
                            <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                ...
                                <div class="invoice-number-date mt-md-0 mt-2">
                                    <div class="d-flex align-items-center justify-content-md-end mb-1">
                                        ...
                                        <div class="input-group input-group-merge invoice-edit-input-group">
                                            <div class="input-group-text">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-hash">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <input type="text" class="form-control invoice-edit-input date-picker flatpickr-input" readonly="readonly">
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="title">Due Date:</span>
                                        <input type="text" class="form-control invoice-edit-input due-date-picker flatpickr-input" readonly="readonly">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body invoice-padding invoice-product-details">
                            <div data-repeater-list="group-a">
                                <div class="repeater-wrapper" data-repeater-item="">
                                    <div class="row">
                                        <div class="col-12 d-flex product-details-border position-relative pe-0 " v-for="(item, index) in items" :key="item.Cost">
                                                ...
                                                <div class="card-body">
                                                    <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                        ...
                                                        <div class="col-lg-3 col-12 my-lg-0 my-2">
                                                            ...
                                                            <input type="number" class="form-control" v-bind:value="item.Cost" placeholder="24">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                            ...
                                                            <p class="card-text mb-0">
                                                                ${{item.Price}}
                                                                 <input type="button" v-on:click="Remove(index)" value="Remove" class="btn btn-danger" />
                                                            </p>
                                                        </div>
                            ...
                            <div class="row mt-1">
                                <div class="col-12 px-0">
                                    <button type="button" class="btn btn-primary btn-sm btn-add-new waves-effect waves-float waves-light" data-repeater-create="">
                                        ...
                                        <span class="align-middle" v-on:click="AddItem()">Add Item</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-4 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="app-invoice-preview.html" class="btn btn-outline-primary w-100 mb-75 waves-effect">Preview</a>
                            <br />
                            <button type="button" class="btn btn-outline-primary w-100 mb-75 waves-effect">Save</button>
                            <br />
                            <button class="btn btn-success w-100 mb-75 waves-effect waves-float waves-light" data-bs-toggle="modal" data-bs-target="#add-payment-sidebar">
                                Add Payment
...
We would appreciate payment of this invoice by 05/11/2019</textarea>
                                ...
                                <div class="mb-1">
                                    <span class="badge badge-light-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-link me-25">
    ...
    <script>
        ...
        new Vue({
            ...
            methods: {
                ...
                Remove(event) {
                    this.items = this.items.filter(function (d, ind) { return ind != event });
                }
            },
            mounted() {
                this.items.push(this.item);
