...
public partial class Admin_Default :  System.Web.UI.Page
{
    ...
    public void FillRole()
    {
        ...
        dtRole = ObjConnection.select_data_dt("ManageRole @Action='GetAll',@ID=0");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
        dt = ObjConnection.select_data_dt("EXEC ManageMenu 'RolePermission', '"+ ddlRole.SelectedValue +"' ,'" + MenuIDStr + "'");
        if (Convert.ToInt32(dt.Rows[0]["id"].ToString()) > 0)
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "6", "<script>alert('Update Successfully'); window.location.href = 'ManagePermission.aspx';</script>", false);
            //FillMenu();
    ...
    private void BindTree()
    {
        ...
        TreeDT = ObjConnection.select_data_dt("EXEC FillMenu @Action='All', @RoleID="+ddlRole.SelectedValue+",@ID=0,@ParentID=0");
