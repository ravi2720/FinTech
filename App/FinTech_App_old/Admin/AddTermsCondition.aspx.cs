...
public partial class Admin_AddTermsCondition : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = cls.select_data_dt("Exec AddEditTermsCondition " + id + ",'" + txtNewsName.Text + "','" + ckNewsDesc.Text + "','"+dtMember.Rows[0]["ID"].ToString()+"','" + company.MemberID + "'");
    ...
    {
        dt = cls.select_data_dt("EXEC ManageTermsCondition 'Get','" + id + "','" + company.MemberID + "'");
    ...
    {
        int val = cls.update_data("ManageTermsCondition @Action='IsActive',@ID=" + id + ",'" + company.MemberID + "'");
        if (val > 0)
        {
            FillData();
        }
