<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="SMSTemplate.aspx.cs" Inherits="Admin_SMSTemplate" %>
                                ...
                                <ContentTemplate>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label for="txtAccountNo">Template Name : </label>
                                                <asp:TextBox runat="server" ID="txtTemplateName" ToolTip="Enter Name" class="form-control ValiDationR"></asp:TextBox>
                                            </div>
                                            <div class="col-md-3">
