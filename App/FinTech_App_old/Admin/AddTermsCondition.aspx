<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddTermsCondition.aspx.cs" Inherits="Admin_AddTermsCondition" %>
                ...
                <section class="content">
                    <asp:UpdatePanel runat="server" ID="updateRolePanel">
                        <ContentTemplate>
                            <div class="card card-primary">
                                <div class="card-header">Manage Terms Condition</div>
                                <div class="card-body">
                                    <asp:HiddenField ID="hdnid" Value="0" runat="server" />
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">News Name</label>
                    ...
                    <div class="container-fluid">
                        <div class="card panel-primary">
                            <div class="card-header">TermsCondition List</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                                                ...
                                                                <asp:Repeater ID="repeater1" runat="server" OnItemCommand="repeater1_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Button ID="btnStatus" runat="server" CssClass='<%# Convert.ToInt32(Eval("IsActive")) == 1 ? "btn btn-success" : "btn btn-warning" %>' Text='<%#Eval("Status") %>' CommandArgument='<%#Eval("ID") %>' CommandName="Active" />
                                                                            <td>
