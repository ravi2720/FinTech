<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="UPIHistory.aspx.cs" Inherits="Admin_UPIHistory" %>
    ...
    <div class="content-wrapper">
        <section class="content">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="card">
                        <h4 class="card-header">UPI Transfer History
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:Button runat="server" ID="Button1" CommandName="CheckStatus" CommandArgument='<%# Eval("OrderID") %>' Text="Check Status" Visible='<%# (Eval("status").ToString().ToUpper()=="PENDING"?true:false) %>' CssClass="btn btn-danger" />
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <a style="color: red;" href='<%# "UPISendReceipt.aspx?TransID="+Eval("OrderID").ToString() %>'>Receipt</a>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
