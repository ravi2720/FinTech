<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddFund.aspx.cs" Inherits="Admin_AddFund" %>
                                                ...
                                                <asp:Repeater ID="rptMember" runat="server" OnItemCommand="rptMember_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td>Add Amount :</td>
                                                            <td>
                                                                <asp:TextBox ID="txtAmount" onkeypress="return event.charCode >= 48" TextMode="Number" MaxLength="8" runat="server" CssClass="form-control" placeholder="Please enter Transfer amount"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Remark</td>
