<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="VirtualSurcharge.aspx.cs" Inherits="Admin_VirtualSurcharge" %>
            ...
            <asp:UpdatePanel runat="server" ID="updateRolePanel">
                <ContentTemplate>
                    <div class="card card-primary">
                        <div class="card-header">Virtual Surcharge Details</div>
                        <div class="card-body">
