<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="RechargeUDaybook.aspx.cs" Inherits="Admin_RechargeUDaybook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <section class="content">
            <div class="card">
                <h4 class="card-header">Recharge User Daybook</h4>
                <div class="card-body">
