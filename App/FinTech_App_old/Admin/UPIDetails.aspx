<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="UPIDetails.aspx.cs" Inherits="Admin_UPIDetails" %>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        <td><%# Container.ItemIndex + 1 %></td>
                                                                         <td><a href='memberupi_details.aspx?upiid=<%#Eval("msrno") %>' class="btn btn-warning">View</a></td>
                                                                        <td><%# Eval("Name") %></td>
                                                                        <td><%# Eval("MemberID") %></td>
                                                                        <td><%# Eval("ICICIUPI") %></td>
                                                                        <td><%# Eval("PAN") %></td>
