<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AadharHistory.aspx.cs" Inherits="Admin_AadharHistory" %>
            ...
            <div class="container-fluid">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">AadharPay History</h4>
                                <div class="row">
                                    <div class="box">
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                                                    ...
                                                                    <asp:Repeater ID="gvTransactionHistory" runat="server">
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a style="color: red;" href='<%# "ReceiptAadhar.aspx?ID="+Eval("RequestID").ToString() %>'>Receipt</a>
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
