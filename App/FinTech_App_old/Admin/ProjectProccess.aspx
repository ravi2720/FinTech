<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ProjectProccess.aspx.cs" Inherits="Admin_ProjectProccess" %>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Font-Bold="True" ForeColor="Red" ControlToValidate="txtName" ValidationGroup="chkaddfund"></asp:RequiredFieldValidator>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Page URL</label>
                                        <asp:TextBox ID="txtPageURL" runat="server" class="form-control m-t-xxs"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" Font-Bold="True" ForeColor="Red" ControlToValidate="txtPageURL" ValidationGroup="chkaddfund"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:FileUpload ID="fileupload" runat="server" class="form-control m-t-xxs"></asp:FileUpload>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Active</label>
                                        <asp:CheckBox ID="chkActive" runat="server" class="form-control m-t-xxs"></asp:CheckBox>
                                    </div>
                                                                ...
                                                                <asp:Repeater ID="repeater1" runat="server" OnItemCommand="repeater1_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td><%#Eval("PageURL") %></td>
                                                                            <td>
                                                                                <img src=' <%# "../images/"+ Eval("url").ToString() %>' />
