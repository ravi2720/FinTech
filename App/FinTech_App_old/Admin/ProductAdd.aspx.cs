...
public partial class Admin_ProductAdd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                BindDropDown.FillDropDown(ddlCategory, "EcommereceCategory", "Name", "ID", "Select Category");
                FillData();
            }
            else
            {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = cls.select_data_dt("Exec AddEditProduct " + ddlCategory.SelectedValue + ",'" + txtHeadingName.Text + "','" + ckNewsDesc.Text + "','" + txtAmount.Text + "',0,1,1,1,'" + BankAccount + "',1,1,1,0");
    ...
    private void FillNews(int id)
    {
        ...
        txtHeadingName.Text = dt.Rows[0]["Name"].ToString();
