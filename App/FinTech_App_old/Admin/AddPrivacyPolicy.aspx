<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddPrivacyPolicy.aspx.cs" Inherits="Admin_AddPrivacyPolicy" %>
                ...
                <section class="content">
                    <asp:UpdatePanel runat="server" ID="updateRolePanel">
                        <ContentTemplate>
                            <div class="card card-primary">
                                <div class="card-header">Manage PrivacyPolicy</div>
                                <div class="card-body">
                                    <asp:HiddenField ID="hdnid" Value="0" runat="server" />
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Header Name</label>
                    ...
                    <div class="container-fluid">
                        <div class="card panel-primary">
                            <div class="card-header">PrivacyPolicy List</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
