<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageFaq.aspx.cs" Inherits="Reatiler_ManageNews" %>
                    ...
                    <asp:UpdatePanel runat="server" ID="updateRolePanel">
                        <ContentTemplate>
                            <div class="panel panel-primary">
                                <div class="panel-heading">Manage Faq</div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Faq Subject :</label>
