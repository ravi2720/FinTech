<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="LocationSystem.aspx.cs" Inherits="Admin_LocationSystem" %>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# Eval("Name") %><br />
                                                        <%# Eval("MemberID") %></td>
                                                    <td><%# Eval("Mobile") %>
                                                        <asp:HiddenField runat="server" ID="hdnData" Value='<%# Eval("Data") %>' />
                                                    </td>
                                                    <td>
                                                        <div class="col-md-12">
