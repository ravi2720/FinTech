<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageMenu.aspx.cs" Inherits="Admin_ManageMenu" %>
                                ...
                                <div class="col-lg-6">
                                    <div class="widgets-container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtClass" class="form-control m-t-xxs" runat="server"></asp:TextBox>
                                        </div>
