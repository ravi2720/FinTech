<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="MATMCommission.aspx.cs" Inherits="Member_MATMCommission" %>
                                ...
                                <table id="file-datatable" class="border-top-0  table table-bordered text-nowrap key-buttons border-bottom">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">Start Val</th>
                                            <th class="border-bottom-0">END Val</th>
