<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="VirtualSurcharge.aspx.cs" Inherits="Member_VirtualSurcharge" %>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Virtual Transfer Surcharge
                                        ...
                                        <table id="file-datatable" class="border-top-0  table table-bordered text-nowrap key-buttons border-bottom">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">Start Value</th>
