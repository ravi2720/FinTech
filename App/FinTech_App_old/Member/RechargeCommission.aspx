<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="RechargeCommission.aspx.cs" Inherits="Member_RechargeCommission" %>
            ...
            <%--<section class="content">
                <div class="container-fluid">
                    <div class="card card-primary">
                        <div class="card-header">Recharge Commission</div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptData">
                                        <ItemTemplate>
                                            <tr class="row2">
                                                ...
                                                <td><%# Eval("isflat").ToString().IsFlatString() %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </tbody>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Recharge Commission
