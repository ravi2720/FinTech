<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="aeps-balance-enquiry.aspx.cs" Inherits="Member_aeps_balance_enquiry" %>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <asp:Button runat="server" disabled='disabled' ID="btnBalance" ClientIDMode="Static" Text="Balance" CssClass="btn btn-success" OnClick="btnBalance_Click" OnClientClick="return ValidateData('.Validate')" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            ...
                            <img src="../img/powerdby.png" style="width: 200px;" />
                                <button type="button" class="btn btn-default" onclick="HideModal()" data-bs-dismiss="modal">Close</button>
