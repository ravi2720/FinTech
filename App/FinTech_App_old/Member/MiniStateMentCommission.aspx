<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="MiniStateMentCommission.aspx.cs" Inherits="Member_MiniStateMentCommission" %>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">MATM Commission
                                        ...
                                        <asp:Repeater runat="server" ID="rptAepsCommission">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="isFlat" Text='<%# Eval("ISFLAT") %>'></asp:Label>
