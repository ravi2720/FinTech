...
public partial class Member_UPIHIstoryBank : System.Web.UI.Page
{
    ...
    private void fillTransactionDetails()
    {
        ...
        dt = cls.select_data_dt("ManageFundAdd_UPI_Virtaul_Transaction ''," + dtMember.Rows[0]["ID"].ToString() + ",'" + txtfromdate.Text + "','" + txttodate.Text + "','0','" + ddlMember.SelectedValue + "'");
