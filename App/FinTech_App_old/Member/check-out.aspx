<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="check-out.aspx.cs" Inherits="Member_check_out" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main-container container-fluid">
                                            ...
                                            <section>
                                                ...
                                                <div class="product">
                                                    <div class="item flex-wrap">
                                                        <div class="left">
                                                            <a href="javascript:void(0);" class="thumb radius">
                                                                <img src="../assets/img/ecommerce/09.jpg" alt="" class="radius">
                                                            </a>
                                                            <div class="purchase">
                                                    ...
                                                    <div class="item flex-wrap">
                                                        <div class="left">
                                                            <a href="javascript:void(0);" class="thumb radius">
                                                                <img src="../assets/img/ecommerce/03.jpg" alt="" class="radius">
                                                            </a>
                                                            <div class="purchase">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-append">
                                                                        <button class="btn btn-primary box-shadow-0" type="button">
      ...
      <!-- Jquery-steps js -->
    <script src="../assets/plugins/checkout-jquery-steps/jquery.steps.min.js"></script>
    <script src="../assets/js/checkout-jquery-steps.js"></script>
