<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="ComplainTicket.aspx.cs" Inherits="Member_AddComplain" %>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-2">
                                            <label>Message :</label>                                            
                                              <asp:TextBox runat="server" ID="txtMessage" TextMode="MultiLine" Rows="5" Columns="5" class="form-control"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="col-md-2 mt-4">
                                            <input type="reset" Class="form-control" value="Cancel" name="btnCancel" id="btnCancel">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Rise Support Ticket
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="file-datatable" class="border-top-0  table table-bordered text-nowrap key-buttons border-bottom">
                                            <thead>
                                                <tr>
                                                    <th class="border-bottom-0">Chat</th>
                                            ...
                                            <tbody>
                                                <asp:Repeater runat="server" ID="rptData">
                                                    <ItemTemplate>
                                                        <tr class="row1">
                                                            <td><a href='<%# "ComplainChat.aspx?ID="+Eval("ID") %>' style="color: white" class="btn btn-danger" target="_self">Chat</a></td>

                                                            <td><span><%# Eval("ID") %></span></td>
