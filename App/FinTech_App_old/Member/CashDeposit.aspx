<%@ Page Title="" Language="C#" MasterPageFile="~/Member/DashBoard.master" AutoEventWireup="true" CodeFile="CashDeposit.aspx.cs" Inherits="Member_CashDeposit" %>
                    ...
                    <div class="container-fluid">
                        <div class="aeps_tabs">
                            <ul>
                                ...
                                <li class="active"><a href="CashDeposit.aspx">Cash Deposit</a></li>
                            </ul>
                        </div>
                        <div class="aeps_form">
                            ...
                            <div class="form-group" runat="server" id="ScanGroup" visible="true">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:Button runat="server" ID="btnCW" disabled='disabled' Text="Cash Deposit" ClientIDMode="Static" CssClass="btn btn-success" OnClick="btnCD_Click" OnClientClick="return ValidateData('.Validate')" />
                                    </div>
                                </div>
                            </div>
