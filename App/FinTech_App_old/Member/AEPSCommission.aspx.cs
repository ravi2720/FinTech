...
public partial class Member_AEPSCommission : System.Web.UI.Page
{
    ...
    private void BindDataAepsCommission()
    {
        try
        {
            dt = objconnection.select_data_dt("EXEC ManageAEPSCommission 'GetByPackageID','" + 0 + "' ,'" + dtMember.Rows[0]["PackageID"] + "'");
