...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <div>
            <img src="../assets/frontpage/img/photo/dist.png" class="img-fluid" alt="Responsive image" style="width: 100%;">
        </div><br>
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                  <div class="content-box benefits">
                    <div>
                        <h2 align="center"><b>Hightest Commissions - Distributors</b></h2>
                    </div>
                          <p style="margin-left:0in; margin-right:0in; text-align:justify"><span style="font-size:16px;"><%=company.Name %> distributorship empowers our Channel Partners to hire number of Retailers / Agents who will sell <%=company.Name %> cashless services like Wallet to Wallet Transfer, PMJAY, UTI & NSDL BRANCH ID, Recharges &amp; to their customers.</span></p>
...
<script type="text/javascript">
    (function () {
        var options = {
            call: "+913848796085", // Call phone number
            whatsapp: "8258888988", // WhatsApp number
